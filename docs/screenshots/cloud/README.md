...
|---|---|---|---|---|
| `demo-repository-light.png` | light | DEMO — Northwind Retail (sample data) — repository view (demo-checkout) | full page | 132 KB |
| `demo-repository-dark.png` | dark | DEMO — Northwind Retail (sample data) — repository view (demo-checkout) | full page | 130 KB |
| `demo-trend-light.png` | light | DEMO — Northwind Retail (sample data) — frame trend (payment.png, 12 runs) | full page | 175 KB |
| `demo-trend-dark.png` | dark | DEMO — Northwind Retail (sample data) — frame trend (payment.png, 12 runs) | full page | 173 KB |
| `demo-trend-hover-light.png` | light | DEMO — Northwind Retail (sample data) — hovering a point on the trend chart names its run | viewport only (1440×900 of 1484px) | 91 KB |
| `demo-trend-hover-dark.png` | dark | DEMO — Northwind Retail (sample data) — hovering a point on the trend chart names its run | viewport only (1440×900 of 1484px) | 89 KB |
...
| `real-trend-light.png` | light | REAL — Normascope's own runs (measured) — frame trend (norma-hero.png, 6 runs) | full page | 121 KB |
| `real-trend-dark.png` | dark | REAL — Normascope's own runs (measured) — frame trend (norma-hero.png, 6 runs) | full page | 119 KB |
| `real-trend-hover-light.png` | light | REAL — Normascope's own runs (measured) — hovering a point on the trend chart names its run | viewport only (1440×900 of 1225px) | 84 KB |
| `real-trend-hover-dark.png` | dark | REAL — Normascope's own runs (measured) — hovering a point on the trend chart names its run | viewport only (1440×900 of 1225px) | 82 KB |
...
| `share-view-light.png` | light | Share view — what someone sent a link receives: no breadcrumb, no Explain, no share panel | full page | 211 KB |
| `share-view-dark.png` | dark | Share view — what someone sent a link receives: no breadcrumb, no Explain, no share panel | full page | 209 KB |
