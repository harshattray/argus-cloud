...
> pages (including that session list), deletion UI, privacy controls, key
> management UI, the invitation *email*, the "generated by" line, and identity
> linking from an account page.
>
