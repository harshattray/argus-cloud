...
/**
 * Billing and usage — an area of the console with no workflows in it yet.
 *
...
export const metadata = {
  title: "Billing and usage — Normascope Cloud",
  robots: { index: false, follow: false },
};

export default async function BillingPage() {
  const context = await consoleContext("billing", "/billing");
  if (context.kind !== "ok") {
